  ...
  return (
    <div className="min-h-screen bg-blue flex flex-col items-center justify-center gap-6 p-6 relative overflow-hidden">
      ...
      <a
        ...
        className="flex items-center gap-2 bg-green-500 hover:bg-green-600 active:scale-95 transition-all text-white font-bold text-lg px-8 py-4 rounded-3xl shadow-lg"
      >
