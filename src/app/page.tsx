  ...
  return (
    <div className="min-h-screen bg-blue flex flex-col items-center justify-center gap-6 p-6 pb-24 relative overflow-hidden">
          ...
          {tiles.map((tile, i) => (
            ...
            >
              <Link
                ...
                className={`${tile.bg} rounded-3xl shadow-xl flex flex-col items-center justify-center gap-3 aspect-[4/3] w-full`}
              >
                <span className="text-6xl">{tile.emoji}</span>
                <span className="text-white text-2xl font-bold">{tile.label}</span>
              </Link>
            </motion.div>
          ))}
        </div>
      ...
      <a
        ...
        className="fixed bottom-4 inset-x-4 z-20 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 active:scale-95 transition-all text-white font-bold text-lg px-8 py-4 rounded-3xl shadow-lg"
      >
      ...
      <a
        ...
        className="text-white/70 text-sm font-normal underline underline-offset-4 pb-4"
      >
